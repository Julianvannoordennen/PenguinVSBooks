...
public class DefinedColors {
    ...
    public static final Color PRIMARY                   = new Color(0.82f, 0, 0, 1);
    public static final Color SECONDARY                 = new Color(0.67f, 0.67f, 0.67f, 1);
    public static final Color PICKUP_FLASH              = new Color(0.2f, 0.2f, 0.8f, 0.5f);
