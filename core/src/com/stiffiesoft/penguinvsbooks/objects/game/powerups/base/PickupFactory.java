...
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.boomerang.BoomerangPickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.clover.CloverPickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.cookie.CookiePickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.dyslexia.DyslexiaPickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.earthquake.EarthquakePickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.extralife.ExtraLifePickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.flamethrower.FlameThrowerPickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.grenade.GrenadePickup;
import com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.hacker.HackerPickup;
...
public class PickupFactory implements EnemyListListener {
    ...
    public Pickup createHelpingBookPickup(Vector2 position) {

        //Create pickup and apply the transform send in parameter
        Pickup pickup = new HelpingBookPickup(beforePickup(position), context);
    ...
    public Pickup createShredderCannonPickup(Vector2 position) {
