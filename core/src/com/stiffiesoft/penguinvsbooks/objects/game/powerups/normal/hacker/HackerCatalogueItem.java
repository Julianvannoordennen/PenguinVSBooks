package com.stiffiesoft.penguinvsbooks.objects.game.powerups.normal.hacker;
...
public class HackerCatalogueItem implements PickupCatalogueItem {
    ...
    public void executeFactoryFunction(PickupFactory pickupFactory, Vector2 position) {
        pickupFactory.createHackerPickup(position);
    }
}
